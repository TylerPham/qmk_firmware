 ...
 * `-----------------------------------------/       /     \     \-----------------------------------------'
 *                  | LAlt | Lower |Bspc  | / Del  /        \Enter\  |Space | Raise | BSLS |
 *                  |      |         |      |/       /          \     \ |      |         |      |
 *                  `-----------------------'         '-------------------------'
 */
[_QWERTY] = LAYOUT(
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                               KC_LALT,  MO(_LOWER), KC_BSPC, KC_DEL,  KC_ENT, KC_SPC,  MO(_RAISE), KC_BSLS
),

/* GAMING
 * Same as QWERTY but without home row mods; Del -> Ctrl, Bslash -> GUI
 */
[_GAMING] = LAYOUT(
    KC_EQUAL,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
    KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                       KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_GRV,
    ...
    KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                               KC_LALT,  MO(_LOWER), KC_BSPC, KC_LCTL,  KC_ENT, KC_SPC,  MO(_RAISE), KC_LGUI
),
...
[_ADJUST] = LAYOUT(
    ...
    CG_TOGG, DF(_QWERTY), DF(_GAMING), XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
